...
Router::scope('/users', ['controller' => 'Users'], function(RouteBuilder $routes) {
    $routes->connect('/login', ['action' => 'login', '[method]' => 'POST']);
...
Router::scope('/permissions', ['controller' => 'Permissions'], function(RouteBuilder $routes) {
    $routes->connect('/add', ['action' => 'add', '[method]' => 'POST']);
    $routes->connect('/update', ['action' => 'update', '[method]' => 'PATCH']);
    $routes->connect('/', ['action' => 'view', '[method]' => 'GET']);
    $routes->connect('/view', ['action' => 'view', '[method]' => 'GET']);
...
Router::scope('/roles', ['controller' => 'Roles'], function(RouteBuilder $routes) {
    $routes->connect('/add', ['action' => 'add', '[method]' => 'POST']);
    $routes->connect('/update', ['action' => 'update', '[method]' => 'PATCH']);
    $routes->connect('/view', ['action' => 'view', '[method]' => 'GET']);
    $routes->connect('/', ['action' => 'view', '[method]' => 'GET']);
