...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(__('Edit Role'), ['action' => 'update', $role->id]) ?> </li>
...
<div class="roles view large-9 medium-8 columns content">
    ...
    <table class="vertical-table">
        ...
        <tr>
            <h4><?= __('Allow Action Ids') ?></h4>
            <?= $this->Text->autoParagraph(h($role->allow_action_ids)); ?>
        </tr>
    </table>
    <div class="row">
    ...
    <div class="related">
        ...
        <table cellpadding="0" cellspacing="0">
            <tr>
                ...
                <th scope="col"><?= __('Confirm Expired Time') ?></th>
            ...
            <tr>
                ...
                <td><?= h($users->confirmation) ?></td>
                <td><?= h($users->confirm_expired_time) ?></td>
